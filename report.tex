...
\begin{itemize}
	...
	\item Clusters managed by a wide range of software, including PBS \cite{PBS}, Torque \cite{Torque}, SGE \cite{SGE}, Slurm \cite{SLURM}, HTCondor \cite{HTCondor}, or OAR \cite{OAR}.
\end{itemize}
