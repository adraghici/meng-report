...
\todo[inline]{Make it clear that it's one of the elements where you've interacted with for your project}
...
\todo[inline,color=cyan]{Figure \ref{GridScaleArch} is pretty ugly, I really wonder who has sketched it...}
...
\todo[inline,color=cyan]{Hey this is a smart way to lay it out! i'll reuse that}
